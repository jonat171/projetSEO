...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="La page Burger de Food Blog ! Vous apprendrez tout sur le burger !">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- The above 4 meta tags *must* come first in the head; any other head content must come *after* these tags -->

    <!-- Title -->
    <title>Food Blog - Burger</title>
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                ...
                                <div class="post-thumb">
                                    <img src="img/blog-img/burger.jpg" alt="burger">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    ...
                                    <h4>Etymologie</h4>
                                    <p>Hamburger fait référence à la ville de Hambourg, en Allemagne. Il n'existe aucun rapport étymologique entre le hamburger et le jambon (ham, en anglais), puisque le nom de la ville de Hambourg a une étymologie différente. Il est courant en Allemagne de nommer les spécialités culinaires selon leur ville d'origine. Le Berliner (beignet fourré de confiture), le Frankfurter (hot-dog) et le Bremer (sorte de pain au poisson dénommé en anglais Fishburger), respectivement originaires de Berlin, Francfort-sur-le-Main et Brême, en sont trois autres exemples. </p>

                                    <img class="br-30 mb-30" src="img/blog-img/burger1.jpg" alt="burger">
                                    <p>La recette a probablement été importée aux États-Unis par des immigrés allemands vers le milieu du xixe siècle. Il s'agissait à l'origine d'un steak servi avec un accompagnement de sauces.Aujourd'hui, en anglais (du moins en anglais américain), le mot hamburger désigne autant le sandwich que le steak haché.</p>

                                    <img class="br-30 mb-30" src="img/blog-img/burger2.jpg" alt="burger">
                                    <p>Les hamburgers sont aujourd'hui composés d'ingrédients beaucoup plus divers qu'autrefois. Hormis les hamburgers traditionnels avec un steak, on en trouve au poulet, au poisson, végétariens ou végétaliens. De nouveaux hamburgers plus excentriques sont créés. On peut trouver par exemple au Japon des hamburgers avec de la salade de choux et du riz.</p>

                                    <img class="br-30 mb-30" src="img/blog-img/burger3.jpg" alt="burger">
                                    ...
                                    <ul class="mb-30">
										...
										Acides gras mono-insaturés 5 g,	
										Acides gras trans 0,8 g</li>
                                        <li>Cholestérol 47 mg</li>
                                        <li>Sodium 414 mg</li>
                                        <li>Potassium 226 mg</li>
                                        <li>Glucides 24 g,	
										Fibres alimentaires 0,9 g,	
										Sucres 4,2 g</li>
                                        <li>Protéines 17 g</li>
                                        <li>Vitamine A	0 IU,	Vitamine C	0 mg,
										Calcium	102 mg,	Fer	2,9 mg,
										Vitamine B6	0,2 mg,	Vitamine B	1,4 µg,
										Magnésium	20 mg	</li>
                                    </ul>
